...
print(Solution().nearestValidPoint(x = 3, y = 4, points = [[1,2],[3,1],[2,4],[2,3],[4,4]])) # 2
print(Solution().nearestValidPoint(x = 3, y = 4, points = [[3,4]])) # 0
print(Solution().nearestValidPoint(x = 3, y = 4, points = [[2,3]])) # -1